...
import { Shield, Eye, Database, Mail, Lock, Trash2, RefreshCcw, DollarSign, Calendar } from "lucide-react";
    ...
    return (
        <div className="py-8 sm:py-12 lg:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
            ...
            >
                ...
                <span style={{ color: "#1C1A17" }}>Privacy & Returns</span>
            </div>
            ...
            <div className="text-center mb-12">
                ...
                >
                    Your privacy matters to us. Learn how we handle your data and our return policies.
                </p>
            </div>
            ...
            <div className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    {privacySections.map((section, index) => {
                        ...
                        return (
                            <div key={index} className="bg-white p-6 rounded-sm border border-[#D0C9BA]">
                                <div className="flex items-center gap-3 mb-3">
                                    <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "#C4954A20" }}>
                                        <Icon size={18} style={{ color: "#C4954A" }} />
                                    </div>
                                    <h3 className="text-base font-semibold" style={{ fontFamily: "Outfit, sans-serif", color: "#1C1A17" }}>
                                        {section.title}
                                    </h3>
                                </div>
                                <p className="text-sm leading-relaxed" style={{ color: "#7A7468", fontFamily: "Outfit, sans-serif" }}>
                                    {section.content}
                                </p>
                            </div>
                        );
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                    {returnSections.map((section, index) => {
                        ...
                        return (
                            <div key={index} className="bg-white p-6 rounded-sm border border-[#D0C9BA]">
                                <div className="w-12 h-12 rounded-full flex items-center justify-center mb-3" style={{ backgroundColor: "#C4954A20" }}>
                                    <Icon size={20} style={{ color: "#C4954A" }} />
                                </div>
                                <h3 className="text-base font-semibold mb-2" style={{ fontFamily: "Outfit, sans-serif", color: "#1C1A17" }}>
                                    {section.title}
                                </h3>
                                <p className="text-sm leading-relaxed" style={{ color: "#7A7468", fontFamily: "Outfit, sans-serif" }}>
                                    {section.content}
