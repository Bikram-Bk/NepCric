...
import { Shield, CheckCircle, AlertCircle, FileText, Scale, Gift, CreditCard, RefreshCcw } from "lucide-react";
    ...
    return (
        <div className="py-8 sm:py-12 lg:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
            ...
            >
                ...
                <span style={{ color: "#1C1A17" }}>Terms & Conditions</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                {termsSections.map((section, index) => {
                    ...
                    return (
                        <div key={index} className="bg-white p-6 rounded-sm border border-[#D0C9BA] hover:shadow-md transition-shadow">
            ...
            <div className="mt-10 bg-[#EDE8DE] p-6 rounded-sm border border-[#D0C9BA] text-center">
                <p className="text-sm" style={{ color: "#7A7468", fontFamily: "Outfit, sans-serif" }}>
                    These terms and conditions were last updated on January 1, 2026. By continuing to use our website, you agree to these terms.
                </p>
            </div>
        </div>
    );
